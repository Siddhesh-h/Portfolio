export default function Info({ icon, heading, detail }) {
    return (
        <div className="bg-glass-bg border border-glass-border p-8 rounded-2xl text-center relative overflow-hidden text-text-primary hover:border-text-primary transition">
