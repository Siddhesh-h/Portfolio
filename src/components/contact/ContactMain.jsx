...
export default function ContactMain() {
    return (
        <section
            id="contact"
            className="bg-bg-secondary relative overflow-hidden z-10 py-16 md:py-24 px-4 md:px-8"
        >
            <div className="w-full max-w-[1200px] m-auto px-4 box-border">
                <div className="text-center mb-6">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 text-text-primary">
                        Get In Touch
                    </h2>
